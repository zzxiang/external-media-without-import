...
3. Add external media. You can do this in either of the following ways:
	* If the 'Media' -> 'Library' page is in grid mode, click the 'Add New' button in the Library page, the media upload panel will show up, in which there's an 'Add External Media without Import' button. Click the button and then the 'Add a media from URL' panel will appear. Fill the URL in the input field and click the 'Add' button, the remote image will be added
